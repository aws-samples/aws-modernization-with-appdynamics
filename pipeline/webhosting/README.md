...
aws cloudformation create-stack --stack-name Appd-modernization-Workshop --template-body file://cloudfront-s3-website.yaml
```
...
```
### DO NOT FORGET TO CHANGE THE STACK NAME
aws cloudformation create-stack --stack-name Appd-modernization-Website-Pipeline --template-body file://pipeline.yaml --capabilities CAPABILITY_NAMED_IAM
```
